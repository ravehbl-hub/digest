...
// Stooq — US stocks & FX (fast, no key, always available)
const STOOQ = [
...
// Yahoo Finance v8 — TASE stocks & indices (last known price even when closed)
const TASE = [
...
// Yahoo Finance v8: has last-close price even when TASE is closed
